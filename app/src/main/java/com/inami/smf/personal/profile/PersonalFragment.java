...
public class PersonalFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mPersonalPagerAdapter = new PersonalPagerAdapter(getChildFragmentManager());
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mViewPager.setAdapter(mPersonalPagerAdapter);
    ...
    private int[] imageResId = {
            R.drawable.activity_feed_material_48dp,
            R.drawable.groups_material_48dp,
            R.drawable.messages_material_48dp,
            R.drawable.profile_material_48dp,
    };

     /* private int[] imageResId = {
            R.drawable.activity_feed_50px,
            R.drawable.groups_50px,
            R.drawable.messages_50px,
            R.drawable.profile_50px,
    }; */
